...
public class FPSController : MonoBehaviour
{
    ...
    public void Interactive()
    {
        ...
        if (character.inventory != null)
            character.Interactive(PlayerView.FPSCamera.RayPointer.transform.position, PlayerView.FPSCamera.RayPointer.transform.forward);
    }
    ...
    public void Checking()
    {
        ...
        character.Checking(PlayerView.FPSCamera.RayPointer.transform.position, PlayerView.FPSCamera.RayPointer.transform.forward);
    }
